...
public class ValidationUtil {
    ...
    public static void getValidationErrorMsg(BindingResult bindingResult, BaseResult commonResultModel) {
        List<FieldError> fieldErrors = bindingResult.getFieldErrors();
        commonResultModel.setRespCode(CommonErrorEnum.PARAM_NULL.getCode());
        commonResultModel.setRespDesc(new StringBuilder(fieldErrors.get(0).getField()).append(" ").append(fieldErrors.get(0).getDefaultMessage()).toString());
    }
}
