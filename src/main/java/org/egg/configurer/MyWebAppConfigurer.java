...
//                .excludePathPatterns("/js/**");
        registry.addInterceptor(new MiniLoginInterceptor(localCache))
                .addPathPatterns("/acceptOrder/**")
                .addPathPatterns("/accountFlow/**")
                .addPathPatterns("/active/**")
                .addPathPatterns("/approve/**")
                .addPathPatterns("/coupon/**")
                .addPathPatterns("/grade/**")
                .addPathPatterns("/publishOrder/**").excludePathPatterns("/publishOrder/queryList")
                .addPathPatterns("/shareRecord/**")
                .addPathPatterns("/user/**").excludePathPatterns("/user/login").excludePathPatterns("/user/wxLogin").excludePathPatterns("/user/wxMiniLogin")
                .excludePathPatterns("/user/register")
                .addPathPatterns("/userHistoryAddress/**")
                .addPathPatterns("/wx/prePay").addPathPatterns("/wx/getRed4MiniFirst")
        ;
