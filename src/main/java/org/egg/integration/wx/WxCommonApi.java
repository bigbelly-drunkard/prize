...
//     *
//     * @param flowEventTypeEnum
//     * @param wxPrePayRequestDto
//     * @return 预支付交易会话标识 prepay_id 微信生成的预支付会话标识，用于后续接口调用中使用，该值有效期为2小时
//     */
//    public WxPrePayResultDto pay(FlowEventTypeEnum flowEventTypeEnum, WxPrePayRequestDto wxPrePayRequestDto) {
...
//        data.put("body", flowEventTypeEnum.getDesc());
...
//                result.setPayType(flowEventTypeEnum.getCode());
//            } else {
