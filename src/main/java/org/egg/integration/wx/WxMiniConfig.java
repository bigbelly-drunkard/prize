 ...
 */
public class WxMiniConfig implements WXPayConfig {
    private byte[] certData;

    public WxMiniConfig() throws Exception {
...
//        }
    ...
    public String getAppID() {
        return WxMiniUtil.APP_ID;
    }

    @Override
    public String getMchID() {
        return WxMiniUtil.MCH_ID;
    }

    @Override
    public String getKey() {
        return WxMiniUtil.KEY;
    }
